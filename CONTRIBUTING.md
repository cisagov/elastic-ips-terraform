...
issue](https://github.com/cisagov/elastic-ips-terraform/issues) in this
...
request](https://github.com/cisagov/elastic-ips-terraform/pulls), you
...
```console
cd elastic-ips-terraform
pyenv virtualenv <python_version_to_use> elastic-ips-terraform
pyenv local elastic-ips-terraform
